...
// QuadDec_v3_0(Counter8bit=false, CounterResolution=4, CounterSize=16, CounterSizeReplacementString=int16, CounterSizeReplacementStringUnsigned=uint16, TypeCastReplacementString=int32, UsingGlitchFiltering=true, UsingIndexInput=false, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=QuadDec_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=QuadDec_M1, CY_INSTANCE_SHORT_NAME=QuadDec_M1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 DP1, INSTANCE_NAME=QuadDec_M1, )
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=1, CompareMode=0, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=32768, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=32768, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=32768, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=16, RunMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=QuadDec_M2:Cnt16, CY_INSTANCE_SHORT_NAME=Cnt16, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 DP1, INSTANCE_NAME=QuadDec_M2_Cnt16, )
...
// QuadDec_v3_0(Counter8bit=false, CounterResolution=4, CounterSize=16, CounterSizeReplacementString=int16, CounterSizeReplacementStringUnsigned=uint16, TypeCastReplacementString=int32, UsingGlitchFiltering=true, UsingIndexInput=false, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=QuadDec_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=QuadDec_M2, CY_INSTANCE_SHORT_NAME=QuadDec_M2, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 DP1, INSTANCE_NAME=QuadDec_M2, )
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=0, CompareValue2=63, CONTROL3=1, ControlReg=false, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=3, DitherOffset=0, EnableMode=0, FF16=false, FF8=true, FixedFunction=true, FixedFunctionUsed=1, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=1, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=255, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, Resolution=8, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=false, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=true, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP8, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_2, CY_INSTANCE_SHORT_NAME=PWM_2, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 DP1, INSTANCE_NAME=PWM_2, )
module PWM_v3_30_8 (
    pwm2,
    tc,
    clock,
...
// ADC_SAR_v3_0(ADC_Clock=1, ADC_Clock_Frequency=1600000, ADC_Input_Range=0, ADC_Power=0, ADC_Reference=0, ADC_Resolution=12, ADC_SampleMode=1, Enable_next_out=false, Ref_Voltage=1.024, Ref_Voltage_mV=1024, rm_int=false, Sample_Precharge=4, Sample_Rate=100000, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=ADC_SAR_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC, CY_INSTANCE_SHORT_NAME=ADC, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 DP1, INSTANCE_NAME=ADC, )
module ADC_SAR_v3_0_9 (
	...
	cy_clock_v1_0
		#(.id("73e67b88-1998-4eda-874f-c7192f1ab730/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
...
module top ;
    ...
    begin : mux_3
        reg  tmp__mux_3_reg;
        always @(Net_2183 or Net_4530 or Net_4399)
        begin
            case (Net_4399)
                1'b0 :  tmp__mux_3_reg = Net_2183;
                1'b1 :  tmp__mux_3_reg = Net_4530;
            endcase
        end
        assign Net_4529 = tmp__mux_3_reg;
    end
    // -- Mux end --
    ...
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_4388 or Net_2183 or Net_4395)
        begin
            case (Net_4395)
                1'b0 :  tmp__mux_1_reg = Net_4388;
                1'b1 :  tmp__mux_1_reg = Net_2183;
            endcase
        end
        assign Net_4533 = tmp__mux_1_reg;
    end
    // -- Mux end --
    ...
    begin : mux_2
        reg  tmp__mux_2_reg;
        always @(Net_2183 or Net_4388 or Net_4395)
        begin
            case (Net_4395)
                1'b0 :  tmp__mux_2_reg = Net_2183;
                1'b1 :  tmp__mux_2_reg = Net_4388;
            endcase
        end
        assign Net_4485 = tmp__mux_2_reg;
    end
    // -- Mux end --
	...
	wire [0:0] tmpOE__INT_SENSOR_LEFT_net;
	wire [0:0] tmpFB_0__INT_SENSOR_LEFT_net;
	wire [0:0] tmpIO_0__INT_SENSOR_LEFT_net;
	wire [0:0] tmpINTERRUPT_0__INT_SENSOR_LEFT_net;
	electrical [0:0] tmpSIOVREF__INT_SENSOR_LEFT_net;

	cy_psoc3_pins_v1_10
		#(.id("f36befb8-1641-4cc9-8456-a63a4750914a"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		INT_SENSOR_LEFT
		 (.oe(tmpOE__INT_SENSOR_LEFT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__INT_SENSOR_LEFT_net[0:0]}),
		  .io({tmpIO_0__INT_SENSOR_LEFT_net[0:0]}),
		  .siovref(tmpSIOVREF__INT_SENSOR_LEFT_net),
		  .interrupt({tmpINTERRUPT_0__INT_SENSOR_LEFT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__INT_SENSOR_LEFT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    assign Net_4723 = 1'h0;
    ...
    begin : mux_4
        reg  tmp__mux_4_reg;
        always @(Net_4530 or Net_2183 or Net_4399)
        begin
            case (Net_4399)
                1'b0 :  tmp__mux_4_reg = Net_4530;
                1'b1 :  tmp__mux_4_reg = Net_2183;
            endcase
        end
        assign Net_4487 = tmp__mux_4_reg;
    end
    // -- Mux end --
    ...
    CyControlReg_v1_80 PWM_CONTROL (
        .control_1(Net_4399),
        .control_2(Net_4346),
        .control_3(Net_4347),
        .control_0(Net_4395),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam PWM_CONTROL.Bit0Mode = 0;
    defparam PWM_CONTROL.Bit1Mode = 0;
    defparam PWM_CONTROL.Bit2Mode = 0;
    defparam PWM_CONTROL.Bit3Mode = 0;
    defparam PWM_CONTROL.Bit4Mode = 0;
    defparam PWM_CONTROL.Bit5Mode = 0;
    defparam PWM_CONTROL.Bit6Mode = 0;
    defparam PWM_CONTROL.Bit7Mode = 0;
    defparam PWM_CONTROL.BitValue = 0;
    defparam PWM_CONTROL.BusDisplay = 0;
    defparam PWM_CONTROL.ExtrReset = 0;
    defparam PWM_CONTROL.NumOutputs = 2;

    CyControlReg_v1_80 H_BRIDGE_CONTROL (
        .control_1(Net_4666),
        .control_2(Net_4370),
        .control_3(Net_4371),
        .control_0(Net_4535),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam H_BRIDGE_CONTROL.Bit0Mode = 0;
    defparam H_BRIDGE_CONTROL.Bit1Mode = 0;
    defparam H_BRIDGE_CONTROL.Bit2Mode = 0;
    defparam H_BRIDGE_CONTROL.Bit3Mode = 0;
    defparam H_BRIDGE_CONTROL.Bit4Mode = 0;
    defparam H_BRIDGE_CONTROL.Bit5Mode = 0;
    defparam H_BRIDGE_CONTROL.Bit6Mode = 0;
    defparam H_BRIDGE_CONTROL.Bit7Mode = 0;
    defparam H_BRIDGE_CONTROL.BitValue = 0;
    defparam H_BRIDGE_CONTROL.BusDisplay = 0;
    defparam H_BRIDGE_CONTROL.ExtrReset = 0;
    defparam H_BRIDGE_CONTROL.NumOutputs = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("348ad929-5a14-456e-b647-f1866cdfb2c6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ed8a3b5e-64be-4d28-9adf-4489563a2ee9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__LINE_SENSOR_CENTRE_net;
	wire [0:0] tmpFB_0__LINE_SENSOR_CENTRE_net;
	wire [0:0] tmpIO_0__LINE_SENSOR_CENTRE_net;
	wire [0:0] tmpINTERRUPT_0__LINE_SENSOR_CENTRE_net;
	electrical [0:0] tmpSIOVREF__LINE_SENSOR_CENTRE_net;

	cy_psoc3_pins_v1_10
		#(.id("a52d4bd6-0fec-44f1-adeb-00e2895a9223"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LINE_SENSOR_CENTRE
		 (.oe(tmpOE__LINE_SENSOR_CENTRE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LINE_SENSOR_CENTRE_net[0:0]}),
		  .io({tmpIO_0__LINE_SENSOR_CENTRE_net[0:0]}),
		  .siovref(tmpSIOVREF__LINE_SENSOR_CENTRE_net),
		  .interrupt({tmpINTERRUPT_0__LINE_SENSOR_CENTRE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LINE_SENSOR_CENTRE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_4448 = ~Net_4535;


    assign Net_4450 = ~Net_4535;
	...
	cy_psoc3_pins_v1_10
		#(.id("fd128dfc-eacf-4341-bd7c-844d3782d3fc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("2f29532c-49c8-433f-8541-551c03daafa0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("2dec2d00-8b53-4bc5-a95c-3066ecdbf1b7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("78644f56-ba1d-4ba1-91eb-34c922681160"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__LINE_SENSOR_LEFT_net;
	wire [0:0] tmpFB_0__LINE_SENSOR_LEFT_net;
	wire [0:0] tmpIO_0__LINE_SENSOR_LEFT_net;
	wire [0:0] tmpINTERRUPT_0__LINE_SENSOR_LEFT_net;
	electrical [0:0] tmpSIOVREF__LINE_SENSOR_LEFT_net;

	cy_psoc3_pins_v1_10
		#(.id("87caf556-bb01-473b-9173-181e01548866"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LINE_SENSOR_LEFT
		 (.oe(tmpOE__LINE_SENSOR_LEFT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LINE_SENSOR_LEFT_net[0:0]}),
		  .io({tmpIO_0__LINE_SENSOR_LEFT_net[0:0]}),
		  .siovref(tmpSIOVREF__LINE_SENSOR_LEFT_net),
		  .interrupt({tmpINTERRUPT_0__LINE_SENSOR_LEFT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LINE_SENSOR_LEFT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LINE_SENSOR_RIGHT_net;
	wire [0:0] tmpFB_0__LINE_SENSOR_RIGHT_net;
	wire [0:0] tmpIO_0__LINE_SENSOR_RIGHT_net;
	wire [0:0] tmpINTERRUPT_0__LINE_SENSOR_RIGHT_net;
	electrical [0:0] tmpSIOVREF__LINE_SENSOR_RIGHT_net;

	cy_psoc3_pins_v1_10
		#(.id("22d6c077-36bc-464e-bcd1-5ba51437e745"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LINE_SENSOR_RIGHT
		 (.oe(tmpOE__LINE_SENSOR_RIGHT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LINE_SENSOR_RIGHT_net[0:0]}),
		  .io({tmpIO_0__LINE_SENSOR_RIGHT_net[0:0]}),
		  .siovref(tmpSIOVREF__LINE_SENSOR_RIGHT_net),
		  .interrupt({tmpINTERRUPT_0__LINE_SENSOR_RIGHT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LINE_SENSOR_RIGHT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SW0_net;
	wire [0:0] tmpFB_0__SW0_net;
	wire [0:0] tmpIO_0__SW0_net;
	wire [0:0] tmpINTERRUPT_0__SW0_net;
	electrical [0:0] tmpSIOVREF__SW0_net;

	cy_psoc3_pins_v1_10
		#(.id("4b3bd980-6002-4eee-a980-882b550dd250"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("017badd6-a477-4f2a-b8ce-9d4bcda0ad20"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("2d8b9a54-aded-4d5b-ba03-bd9564db864b"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__v_bat_net;
	wire [0:0] tmpFB_0__v_bat_net;
	wire [0:0] tmpIO_0__v_bat_net;
	wire [0:0] tmpINTERRUPT_0__v_bat_net;
	electrical [0:0] tmpSIOVREF__v_bat_net;

	cy_psoc3_pins_v1_10
		#(.id("8be13001-4833-4e4a-b803-e8314fe7202f"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		v_bat
		 (.oe(tmpOE__v_bat_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__v_bat_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__v_bat_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__INT_SENSOR_RIGHT_net;
	wire [0:0] tmpFB_0__INT_SENSOR_RIGHT_net;
	wire [0:0] tmpIO_0__INT_SENSOR_RIGHT_net;
	wire [0:0] tmpINTERRUPT_0__INT_SENSOR_RIGHT_net;
	electrical [0:0] tmpSIOVREF__INT_SENSOR_RIGHT_net;

	cy_psoc3_pins_v1_10
		#(.id("c7ac9f4b-36b4-47f5-bd9d-22516538b15a"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		INT_SENSOR_RIGHT
		 (.oe(tmpOE__INT_SENSOR_RIGHT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__INT_SENSOR_RIGHT_net[0:0]}),
		  .io({tmpIO_0__INT_SENSOR_RIGHT_net[0:0]}),
		  .siovref(tmpSIOVREF__INT_SENSOR_RIGHT_net),
		  .interrupt({tmpINTERRUPT_0__INT_SENSOR_RIGHT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__INT_SENSOR_RIGHT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
