...
{
    uint8 staticBits = (SW0_DR & (uint8)(~SW0_MASK));
    SW0_DR = staticBits | ((uint8)(value << SW0_SHIFT) & SW0_MASK);
}
...
{
	CyPins_SetPinDriveMode(SW0_0, mode);
}
...
uint8 SW0_Read(void)
{
    return (SW0_PS & SW0_MASK) >> SW0_SHIFT;
}
...
{
    return (SW0_DR & SW0_MASK) >> SW0_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(SW0_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & SW0_0_INTR) != 0u) 
		{ 
			 SW0_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (SW0_INTSTAT & SW0_MASK) >> SW0_SHIFT;
    }
